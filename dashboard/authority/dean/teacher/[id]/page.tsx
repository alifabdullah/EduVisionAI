...
// All Teacher Data — keyed by ID
const TEACHER_DB: Record<string, Partial<typeof initialTeacherData>> = {
  'TCH-001': { id: 'TCH-001', name: 'Dr. Md. Sarwar Hossain Mollah', photo: '/images/teachers/sarwar.png', department: 'Computer Science & Engineering', designation: 'Associate Professor', email: 'headcis@diu.edu.bd', phone: '+8801711000001', joiningDate: '2015-08-12', status: 'Active', teachingScore: 92, researchScore: 88, mentorshipScore: 95, overallKPI: 91 },
  'TCH-002': { id: 'TCH-002', name: 'Dr. Anika Rahman', photo: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=100&h=100&fit=crop', department: 'Computer Science & Engineering', designation: 'Professor', email: 'anika.cse@diu.edu.bd', phone: '+8801711000002', joiningDate: '2012-03-01', status: 'Active', teachingScore: 95, researchScore: 93, mentorshipScore: 90, overallKPI: 96 },
  'TCH-003': { id: 'TCH-003', name: 'Prof. Rashid Khan', photo: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100&h=100&fit=crop', department: 'Electrical & Electronic Engineering', designation: 'Professor', email: 'rashid.eee@diu.edu.bd', phone: '+8801711000003', joiningDate: '2010-07-15', status: 'Active', teachingScore: 88, researchScore: 85, mentorshipScore: 80, overallKPI: 88 },
  'TCH-004': { id: 'TCH-004', name: 'Dr. Tamanna Akter', photo: '/images/teachers/tamanna.png', department: 'Computing and Information System', designation: 'Lecturer', email: 'tamanna@daffodilvarsity.edu.bd', phone: '+8801711000004', joiningDate: '2020-01-10', status: 'Active', teachingScore: 85, researchScore: 60, mentorshipScore: 88, overallKPI: 82 },
  'TCH-005': { id: 'TCH-005', name: 'Dr. Nusrat Jahan', photo: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&h=100&fit=crop', department: 'Software Engineering', designation: 'Associate Professor', email: 'nusrat.swe@diu.edu.bd', phone: '+8801711000005', joiningDate: '2016-06-01', status: 'Active', teachingScore: 90, researchScore: 82, mentorshipScore: 85, overallKPI: 85 },
  'TCH-006': { id: 'TCH-006', name: 'Mr. Anisur Rahman', photo: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop', department: 'Computer Science & Engineering', designation: 'Lecturer', email: 'anisur.cse@diu.edu.bd', phone: '+8801711000006', joiningDate: '2021-09-01', status: 'Active', teachingScore: 76, researchScore: 50, mentorshipScore: 70, overallKPI: 72 },
  'TCH-007': { id: 'TCH-007', name: 'Dr. Laila Hossain', photo: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&h=100&fit=crop', department: 'Computer Science & Engineering', designation: 'Assistant Professor', email: 'laila.cse@diu.edu.bd', phone: '+8801711000007', joiningDate: '2018-03-20', status: 'Active', teachingScore: 86, researchScore: 78, mentorshipScore: 84, overallKPI: 84 },
  'TCH-008': { id: 'TCH-008', name: 'Prof. Karim Uddin', photo: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop', department: 'Software Engineering', designation: 'Professor', email: 'karim.swe@diu.edu.bd', phone: '+8801711000008', joiningDate: '2008-11-01', status: 'Active', teachingScore: 94, researchScore: 96, mentorshipScore: 92, overallKPI: 95 },
  'TCH-009': { id: 'TCH-009', name: 'Dr. Shirin Begum', photo: 'https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?w=100&h=100&fit=crop', department: 'Computing and Information System', designation: 'Associate Professor', email: 'shirin.cis@diu.edu.bd', phone: '+8801711000009', joiningDate: '2014-04-15', status: 'Active', teachingScore: 81, researchScore: 75, mentorshipScore: 80, overallKPI: 80 },
  'TCH-010': { id: 'TCH-010', name: 'Mr. Tanvir Ahmed', photo: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=100&h=100&fit=crop', department: 'Electrical & Electronic Engineering', designation: 'Senior Lecturer', email: 'tanvir.eee@diu.edu.bd', phone: '+8801711000010', joiningDate: '2019-07-01', status: 'Active', teachingScore: 79, researchScore: 55, mentorshipScore: 72, overallKPI: 75 },
};

// Initial Mock Data for Teacher (fallback)
...
export default function Teacher360Profile({ params }: { params: Promise<{ id: string }> }) {
  ...
  // Load correct teacher data from the DB based on URL id param
  const resolvedData = { ...initialTeacherData, ...(TEACHER_DB[resolvedParams.id] ?? {}) };
  const [teacher, setTeacher] = useState(resolvedData);
